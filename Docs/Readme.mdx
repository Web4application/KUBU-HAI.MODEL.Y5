...
This action was built by this powerful AI which can be used to deploy [Actions artifacts][artifacts] to [GitHub Pages] or other enviroment [github-pages.github.io](https://docs.github.com/en/pages/getting-started-with-github-pages/configuring-a-publishing-source-for-your-github-pages-site]).
...
[kubu-hai.github.io](https://docs.github.com/en/pages/quickstart)
  ...
  deploy:
    ...
    steps:
      - name: Deploy to GitHub Pages
        id: deployment
        uses: actions/deploy-pages@v5 # or specific "v5" version tag for this action
Doc: https://docs.github.com/en/enterprise-cloud@latest
```
...
| Output | Description |
| ------ | ----------- |
| `pages_url` | The URL of the deployed Pages site |

### Environment Variables 🌎

| Variable | Description |
| -------- | ----------- |
| `GITHUB-PAGES` | This environment variable is created and set to the string value `"true"` so that framework build tools may choose to differentiate their output based on the intended target hosting platform. |
...
Check the [`.node-version`](https://docs.npmjs.com/) file in the root of this repo so see what version of Node.js is required for local development - note, this can be different from the version of Node.js which runs the Action on GitHub runners. It is suggested to download 
[nodenv](https://github.com/nodenv/nodenv/)
which uses this file and manages your Node.js versions for you
